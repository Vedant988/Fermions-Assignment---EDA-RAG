module top (
    ...
    alu u_alu (
        ...
        .alu_op (ctrl_alu_op),
        .result (alu_result),
        .zero   ()             // Zero flag completely unused, branch_unit handles comparisons
    );
    ...
    pc_next u_pc_next (
        ...
        .jump      (ctrl_jump),
        .jump_type ({2'b00, ctrl_jump_type}), // Zero padded to match the 3-bit input
        .pc_next   (next_pc)
    );
    ...
    load_store u_load_store (
        // NO clk port here, module is purely combinational
        .mem_read   (ctrl_mem_read),
        .mem_write  (ctrl_mem_write),
        .mem_size   (ctrl_mem_size),
        .mem_extend (ctrl_mem_extend),
