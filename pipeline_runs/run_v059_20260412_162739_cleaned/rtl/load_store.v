module load_store (
    ...
    logic [4:0] shift_amt;
    assign shift_amt = {3'b000, byte_offset} << 3;   // 8 * byte_offset
    ...
    always_comb begin
        case (mem_size)
            2'b00: byte_mask = 32'h000000ff << shift_amt;
            2'b01: byte_mask = 32'h0000ffff << shift_amt;
    ...
    assign mem_wdata = (wdata_shifted & byte_mask) & ({28'd0, mem_wstrb} << shift_amt);
